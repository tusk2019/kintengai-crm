          ...
          <div class="card-tools">
            <div class="input-group input-group-sm" style="width: 250px;">
              <div class="input-group-append">
                ...
                <a href="https://kintengai.booktown.tokyo/index.php/ClientaddC">
          ...
          <table class="table table-hover text-nowrap">
            ...
            <tbody>
              ...
              <tr>
                ...
                <td>                  
                  <a href="https://kintengai.booktown.tokyo/index.php/ClienteditC?id=<?php echo $row['id'] ?>">
                    <button type="button" class="btn btn-block btn-success">編集</button>
                  </a>
                </td>
                <td>
                  <a href="https://kintengai.booktown.tokyo/index.php/ClientdeleteC?id=<?php echo $row['id'] ?>">
